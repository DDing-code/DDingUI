...
-- 60+ design tokens (inspired by DDingUI)
...
-- ============================================
Tokens.MOTION_FAST      = 0.075
Tokens.MOTION_BASE      = 0.18
Tokens.MOTION_POP       = 0.22
Tokens.MOTION_FLASH     = 0.28
Tokens.MOTION_OVERSHOOT = 1.08
