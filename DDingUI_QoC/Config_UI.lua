...
local ADDON_KEY = "QoC"  -- StyleLib 악센트 프리셋 키
...
-- ReloadUI 팝업
------------------------------------------------------
StaticPopupDialogs["DDINGQOC_RELOAD_CONFIRM"] = {
...
local function SetValue(setting, value)
    ...
    if setting.reloadRequired then
        StaticPopup_Show("DDINGQOC_RELOAD_CONFIRM")
    end
end
...
function ConfigUI:Initialize()
    ...
    settingsPanel = Lib.CreateSettingsPanel(ADDON_KEY, "DDingUI QoC", version, {
