...
local L = LibStub("AceLocale-3.0"):NewLocale("DDingUI_QoC", "enUS", true)
...
L["TAB_BUFFCHECKER"] = "Buff Checker"
...
-- Movers / Edit Mode
-- ==========================================
L["MOVER_TITLE"] = "Edit Mode"
L["MOVER_ENABLED"] = "Edit mode enabled. Drag frames to adjust positions."
L["MOVER_DISABLED"] = "Edit mode disabled. Positions saved."
L["MOVER_COMBAT"] = "Cannot toggle edit mode during combat."
L["MOVER_COMBAT_EXIT"] = "Edit mode auto-closed due to combat."
L["MOVER_NO_SELECTION"] = "No selection"
L["MOVER_RESET"] = "Reset"
L["MOVER_UNDO"] = "Undo"
L["MOVER_REDO"] = "Redo"
L["MOVER_DONE"] = "Done"
L["MOVER_GRID"] = "Grid"
L["MOVER_SNAP"] = "Snap"
L["MOVER_PHANTOM"] = "(Inactive)"
L["MOVER_PT_MANA"] = "Party Tracker (Healer Mana)"
L["EDIT_POSITION"] = "Edit Position"
...
L["MINIMAP_RIGHT_CLICK"] = "Right-click to toggle edit mode"
...
L["MODULE_RAIDBUFFMANAGER"] = "RaidBuffManager - Raid Buff Tracking/Click to Cast"

-- RaidBuffManager
L["RAIDBUFF_TITLE"] = "Raid Buff Manager"
L["RAIDBUFF_DESC"] = "Track missing raid/party buffs with click-to-cast and distance glow."
L["RAIDBUFF_GROW_DIR"] = "Growth Direction"
L["RAIDBUFF_DIR_RIGHT"] = "Right"
L["RAIDBUFF_DIR_LEFT"] = "Left"
L["RAIDBUFF_DIR_UP"] = "Up"
L["RAIDBUFF_DIR_DOWN"] = "Down"
L["RAIDBUFF_TRACK_MODE"] = "Tracking Mode"
L["RAIDBUFF_MODE_ALL"] = "Track All"
L["RAIDBUFF_MODE_MINE"] = "Castable Only"
L["RAIDBUFF_MODE_CUSTOM"] = "Custom"
L["RAIDBUFF_MISSING"] = "Missing:"
L["RAIDBUFF_ALL_GOOD"] = "Everyone is buffed!"
L["RAIDBUFF_CLICK_CAST"] = "<Left-Click to Cast>"
L["RAIDBUFF_DRAG"] = "RBM Drag"

-- PartyTracker
L["PARTYTRACKER_TITLE"] = "Party Tracker"
L["PARTYTRACKER_DESC"] = "Battle Res charges, Bloodlust debuff, and Healer mana tracking."
L["PARTYTRACKER_DISPLAY_SETTINGS"] = "Display Settings"
L["PARTYTRACKER_SHOW_PARTY"] = "Show in Party"
L["PARTYTRACKER_SHOW_RAID"] = "Show in Raid"
L["PARTYTRACKER_SHOW_MANA_BAR"] = "Show Mana Bar"
L["PARTYTRACKER_SHOW_MANA_TEXT"] = "Show Mana Text"
...
L["PARTYTRACKER_MANA_BAR_SETTINGS"] = "Mana Bar Settings"
...
L["PARTYTRACKER_MANA_POSITION_RESET_MSG"] = "Mana frame position has been reset."
L["PARTYTRACKER_TEST_START"] = "PartyTracker Test Mode ON"
L["PARTYTRACKER_TEST_END"] = "PartyTracker Test Mode OFF"
L["PT_BATTLE_RES"] = "Battle Res"
L["PT_CHARGES"] = "Charges"
L["PT_NEXT_CHARGE"] = "Next Charge"
L["PT_BLOODLUST"] = "Bloodlust"
L["PT_LUST_READY"] = "Ready"
L["PT_LUST_EXHAUSTION"] = "Remaining"
L["PT_MANA"] = "Mana"
L["PT_DEAD"] = "Dead"
L["PT_OFFLINE"] = "Offline"
...
-- ==========================================
-- BuffChecker Module (Unified)
-- ==========================================
L["BUFFCHECKER_TITLE"] = "Buff Checker"
L["BUFFCHECKER_DESC"] = "Alerts via icons when class buffs, consumables (food/flask/rune/oil), pets, or stances are missing."

L["BUFFCHECKER_DISPLAY_SETTINGS"] = "General & Display Conditions"
L["BUFFCHECKER_ZONE_CHECK"] = "Activation Conditions"
L["BUFFCHECKER_ZONE_ALWAYS"] = "Always On"
L["BUFFCHECKER_ZONE_INSTANCE"] = "Dungeon/Raid Only"
L["BUFFCHECKER_ZONE_GROUP"] = "In Party/Raid Only"
L["BUFFCHECKER_ZONE_BOTH"] = "Instance OR Group"
L["BUFFCHECKER_HIDE_COMBAT"] = "Hide in Combat"
L["BUFFCHECKER_IGNORE_MOUNTED"] = "Hide While Mounted"
L["BUFFCHECKER_IGNORE_RESTING"] = "Hide While Resting"
L["BUFFCHECKER_THRESHOLD"] = "Warning Threshold (Minutes)"

L["BUFFCHECKER_UI_SETTINGS"] = "Frame & Icon Layout"
L["BUFFCHECKER_GLOW_TYPE"] = "Glow Effect Type"
L["BUFFCHECKER_GLOW_COLOR"] = "Glow Color"

L["BUFFCHECKER_CHECK_CONSUMABLES"] = "Consumables Status Check"
L["BUFFCHECKER_CHECK_FOOD"] = "Check Missing Food (Well Fed)"
L["BUFFCHECKER_CHECK_FLASK"] = "Check Missing Flask Buff"
L["BUFFCHECKER_CHECK_WEAPON"] = "Check Missing Weapon Oil/Stone"
L["BUFFCHECKER_CHECK_RUNE"] = "Check Missing Augment Rune"

L["BUFFCHECKER_CHECK_CLASS"] = "Class Specific Alerts (Synergy/Pet/Stance)"
L["BUFFCHECKER_CHECK_CLASSBUFF"] = "Party Synergy Buff (Mage/Priest/Warrior/Druid etc)"
L["BUFFCHECKER_CHECK_PET"] = "Missing Pet / Wait for Res (Hunter/Warlock etc)"
L["BUFFCHECKER_CHECK_STANCE"] = "Combat Stance / Auras (Warrior/Paladin)"
L["BUFFCHECKER_CHECK_POISONS"] = "Missing Weapon Poisons (Rogue)"
