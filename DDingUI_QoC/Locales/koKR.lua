...
local L = LibStub("AceLocale-3.0"):NewLocale("DDingUI_QoC", "koKR")
...
-- ==========================================
L["MOVER_TITLE"] = "편집 모드"
L["MOVER_ENABLED"] = "편집 모드 활성화. 프레임을 드래그하여 위치를 조정하세요."
L["MOVER_DISABLED"] = "편집 모드 종료. 위치가 저장되었습니다."
L["MOVER_COMBAT"] = "전투 중에는 편집 모드를 사용할 수 없습니다."
L["MOVER_COMBAT_EXIT"] = "전투 진입으로 편집 모드가 자동 종료되었습니다."
L["MOVER_NO_SELECTION"] = "선택 없음"
L["MOVER_RESET"] = "초기화"
L["MOVER_UNDO"] = "실행취소"
L["MOVER_REDO"] = "재실행"
L["MOVER_DONE"] = "완료"
...
L["MOVER_SNAP"] = "스냅"
L["MOVER_PHANTOM"] = "(비활성)"
L["MOVER_PT_MANA"] = "파티 트래커 (힐러 마나)"
L["EDIT_POSITION"] = "위치 편집"
...
L["MODULE_RAIDBUFFMANAGER"] = "RaidBuffManager - 공격대 버프 추적/클릭 시전"

-- RaidBuffManager
L["RAIDBUFF_TITLE"] = "공격대 버프 관리"
L["RAIDBUFF_DESC"] = "공격대/파티 버프 누락 추적 · 클릭 시전 · 거리 글로우"
L["RAIDBUFF_GROW_DIR"] = "성장 방향"
L["RAIDBUFF_DIR_RIGHT"] = "오른쪽"
L["RAIDBUFF_DIR_LEFT"] = "왼쪽"
L["RAIDBUFF_DIR_UP"] = "위쪽"
L["RAIDBUFF_DIR_DOWN"] = "아래쪽"
L["RAIDBUFF_TRACK_MODE"] = "추적 모드"
L["RAIDBUFF_MODE_ALL"] = "모두 추적"
L["RAIDBUFF_MODE_MINE"] = "내 시전 가능 버프만"
L["RAIDBUFF_MODE_CUSTOM"] = "사용자 지정"
L["RAIDBUFF_MISSING"] = "누락:"
L["RAIDBUFF_ALL_GOOD"] = "모두 버프 받음!"
L["RAIDBUFF_CLICK_CAST"] = "<좌클릭하여 시전>"
L["RAIDBUFF_DRAG"] = "RBM 드래그"
L["MODULE_PARTYTRACKER"] = "PartyTracker - 전투부활/블러드/힐러 마나 추적"

-- PartyTracker
L["PARTYTRACKER_TITLE"] = "파티 트래커"
L["PARTYTRACKER_DESC"] = "전투부활 충전 · 블러드 디버프 · 힐러 마나 추적"
L["PARTYTRACKER_DISPLAY_SETTINGS"] = "표시 설정"
L["PARTYTRACKER_SHOW_PARTY"] = "파티에서 표시"
L["PARTYTRACKER_SHOW_RAID"] = "레이드에서 표시"
L["PARTYTRACKER_SHOW_MANA_BAR"] = "마나바 표시"
L["PARTYTRACKER_SHOW_MANA_TEXT"] = "마나 텍스트 표시"
L["PARTYTRACKER_SEPARATE_MANA"] = "힐러 마나 분리 표시"
L["PARTYTRACKER_SIZE_SETTINGS"] = "크기 설정"
L["PARTYTRACKER_FONT_SETTINGS"] = "글꼴 설정"
L["PARTYTRACKER_MANA_BAR_SETTINGS"] = "마나바 설정"
L["PARTYTRACKER_MANA_BAR_WIDTH"] = "마나바 너비"
L["PARTYTRACKER_MANA_BAR_HEIGHT"] = "마나바 높이"
L["PARTYTRACKER_MANA_BAR_TEXTURE"] = "마나바 텍스쳐"
L["PARTYTRACKER_MANA_POSITION_RESET"] = "마나 위치 초기화"
L["PARTYTRACKER_MANA_POSITION_RESET_MSG"] = "마나 프레임 위치가 초기화되었습니다."
L["PARTYTRACKER_TEST_START"] = "PartyTracker 테스트 모드 ON"
L["PARTYTRACKER_TEST_END"] = "PartyTracker 테스트 모드 OFF"
L["PT_BATTLE_RES"] = "전투 부활"
L["PT_CHARGES"] = "충전"
L["PT_NEXT_CHARGE"] = "다음 충전"
L["PT_BLOODLUST"] = "블러드"
L["PT_LUST_READY"] = "사용 가능"
L["PT_LUST_EXHAUSTION"] = "디버프 남은 시간"
L["PT_MANA"] = "마나"
L["PT_DEAD"] = "사망"
L["PT_OFFLINE"] = "오프라인"
...
-- ==========================================
L["BUFFCHECKER_TITLE"] = "버프 체커"
L["BUFFCHECKER_DESC"] = "개인/직업 버프, 소모품(음식/영약/룬/오일), 펫, 태세 등 누락 시 아이콘 알림"

L["BUFFCHECKER_DISPLAY_SETTINGS"] = "일반 및 표시 조건 설정"
L["BUFFCHECKER_ZONE_CHECK"] = "활성화 위치 조건"
L["BUFFCHECKER_ZONE_ALWAYS"] = "항상 켜기"
L["BUFFCHECKER_ZONE_INSTANCE"] = "던전/레이드 내에서만"
L["BUFFCHECKER_ZONE_GROUP"] = "파티/레이드 소속일 때만"
L["BUFFCHECKER_ZONE_BOTH"] = "인스턴스 내부 또는 파티 구성 시"
L["BUFFCHECKER_HIDE_COMBAT"] = "전투 중 숨기기"
L["BUFFCHECKER_IGNORE_MOUNTED"] = "탈것 탑승 중 숨기기"
L["BUFFCHECKER_IGNORE_RESTING"] = "휴식 상태 시 숨기기"
L["BUFFCHECKER_THRESHOLD"] = "남은 시간 경고 (분)"

L["BUFFCHECKER_UI_SETTINGS"] = "프레임 및 아이콘 레이아웃"
L["BUFFCHECKER_GLOW_TYPE"] = "글로우(반짝임) 효과 종류"
L["BUFFCHECKER_GLOW_COLOR"] = "글로우 색상"

L["BUFFCHECKER_CHECK_CONSUMABLES"] = "소모품 (도핑) 상태 확인"
L["BUFFCHECKER_CHECK_FOOD"] = "요리 버프 (포만감) 부족 확인"
L["BUFFCHECKER_CHECK_FLASK"] = "영약 버프 부족 확인"
L["BUFFCHECKER_CHECK_WEAPON"] = "무기 오일 / 숫돌 적용 확인"
L["BUFFCHECKER_CHECK_RUNE"] = "증강의 룬 적용 확인"

L["BUFFCHECKER_CHECK_CLASS"] = "직업 특화 알림 (시너지/펫/태세)"
L["BUFFCHECKER_CHECK_CLASSBUFF"] = "파티 시너지 마법 (법사/사제/전사/드루 등)"
L["BUFFCHECKER_CHECK_PET"] = "소환수 부재 및 부활 대기 (냥꾼/흑마/등)"
L["BUFFCHECKER_CHECK_STANCE"] = "전투 태세 및 기본 오라 켜기 (전사/기사)"
L["BUFFCHECKER_CHECK_POISONS"] = "무기 독 바르기 누락 확인 (도적)"
...
L["PARTYTRACKER_SHOW_RAID"] = "레이드에서 표시 (힐러마나만)"
