...
function ConfigUI:Initialize()
    ...
    if Lib.Motion and Lib.Motion.BindPanel then Lib.Motion.BindPanel(settingsPanel.frame) end
...
function ConfigUI:Toggle()
    if settingsPanel and settingsPanel.frame:IsShown() and not settingsPanel.frame._ddslPanelClosing then
        self:Hide()
    else
        self:Show()
    end
