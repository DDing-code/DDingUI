--[[
    DDingToolKit - BuffReminder: Beneficiaries
    Classes/Specs that benefit from each raid buff.
...
ns.SpecBeneficiaries = {
    intellect = {
        ...
        [1467] = true, [1468] = true, [1473] = true,  -- Evoker: Devastation, Preservation, Augmentation
        [1480] = true,                                 -- Demon Hunter: Devourer
    },
    attackPower = {
        [71] = true, [72] = true, [73] = true,        -- Warrior: Arms, Fury, Protection
        [259] = true, [260] = true, [261] = true,     -- Rogue: Assassination, Outlaw, Subtlety
        [253] = true, [254] = true, [255] = true,     -- Hunter: Beast Mastery, Marksmanship, Survival
