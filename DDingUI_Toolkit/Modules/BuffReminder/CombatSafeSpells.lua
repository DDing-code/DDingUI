--[[
    DDingToolKit - BuffReminder: Combat Safe Spells
    Blizzard whitelisted spell IDs for C_UnitAuras.GetUnitAuraBySpellID() during
    restricted contexts (combat, boss encounters, M+ keystones).
    Ported from BuffReminders by zerbi.
]]

local _, ns = ...

ns.COMBAT_SAFE_SPELLS = {
    -- ========================================================================
