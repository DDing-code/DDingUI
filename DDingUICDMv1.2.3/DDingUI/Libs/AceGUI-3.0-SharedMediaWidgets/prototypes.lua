...
-- DDingUI: Version bumped to ensure our metatable fix loads
local DataVersion = 9999
...
-- Use metatables to always get fresh data from LibSharedMedia
-- This ensures newly registered media appears in dropdowns
-- Also ensures the list is always current when other addons register new media
AceGUIWidgetLSMlists = setmetatable({}, {
	__index = function(t, key)
		return Media:HashTable(key)
	end
})
