            ...
            player = {
                ...
                args = {
                    ...
                    textFont = {
                        ...
                        get = function()
                            return DDingUI.db.profile.castBar.textFont or DDingUI.DEFAULT_FONT_NAME
                        end,
                        set = function(_, val)
                            DDingUI.db.profile.castBar.textFont = val
                            DDingUI:UpdateCastBarLayout()
                        end,
                    },
                    textSize = {
                        ...
                        width = "normal",
                        min = 6, max = 20, step = 1,
                        get = function() return DDingUI.db.profile.castBar.textSize end,
                        set = function(_, val)
                            DDingUI.db.profile.castBar.textSize = val
                            DDingUI:UpdateCastBarLayout()
                        end,
                    },
                    showTimeText = {
