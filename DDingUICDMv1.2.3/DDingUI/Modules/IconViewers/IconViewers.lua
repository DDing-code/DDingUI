...
function IconViewers:ForceRefreshBuffIcons()
    ...
    if viewer and viewer:IsShown() then
        ...
        print("|cff00ff00[DDingUI] Force refreshed BuffIconCooldownViewer|r")
    end
end
...
function IconViewers:AutoLoadBuffIcons(retryCount)
    ...
    if settingsFrame then
        ...
        if not GetViewerState(settingsFrame).layoutHook then
            GetViewerState(settingsFrame).layoutHook = true
