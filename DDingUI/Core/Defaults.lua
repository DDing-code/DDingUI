...
local defaults = {
    ...
    global = {
        -- 계정 전체 공유: 같은 전문화 캐릭터 간 trackedBuffs 공유
    ...
    profile = {
        ...
        viewers = {
            general = {
                ...
                cooldownTextAnchor = "CENTER", -- [12.0.1]
                cooldownTextOffsetX = 0, -- [12.0.1]
                cooldownTextOffsetY = 0, -- [12.0.1]
                cooldownShadowOffsetX = 0,
                cooldownShadowOffsetY = 0,
                cooldownTextFormat = "auto", -- auto, seconds, mmss, decimal
                countTextColor = {1, 1, 1, 1}, -- [12.0.1]
                procGlow = {
                    enabled = true,
                    glowType = "Pixel Glow",
            ...
            BuffIconCooldownViewer = {
                ...
                durationTextFont = nil, -- [12.0.1] nil = general 폰트 사용
                durationTextSize = 14, -- [12.0.1]
                durationTextColor = {1, 1, 1, 1}, -- [12.0.1]
                disableSwipeAnimation = false,
        ...
        powerBar = {
            enabled           = true,
            attachTo          = "DDingUI_Anchor_Cooldowns",
            anchorPoint       = "TOP",
            selfPoint         = "BOTTOM",
            frameStrata       = "MEDIUM",
            height            = 14,
        ...
        castBar = {
            ...
            showChannelTickMarks = true,
            channelTickColor = { 1.0, 1.0, 1.0, 0.7 },
            showChannelLastTick = false,
            channelLastTickColor = { 1.0, 0.82, 0.0, 0.95 },
            enabled       = true,
            attachTo      = "DDingUI_Anchor_Cooldowns",
            anchorPoint   = "TOP",
            selfPoint     = "CENTER",
        ...
        groupSystem = {
            ...
            groups = {
                ...
                ["Cooldowns"] = {
                    order = 1,
                    groupType = "cdm", -- [DYNAMIC] "cdm" | "dynamic"
                    groupCategory = "skill", -- [CATEGORY] "skill" | "buff"
                    autoFilter = "COOLDOWN", -- EssentialCooldownViewer 소속
                    enabled = true,
                    iconSize = 36,
                    aspectRatioCrop = 1.0,
                    spacing = 2,
                    ...
                    offsetX = 0,
                    offsetY = 0, -- [REPARENT] CreateGroupFrame이 뷰어 위치에서 마이그레이션
                    _viewerPosMigrated = true, -- [REPARENT] 뷰어 위치 마이그레이션 완료 플래그
                },
                ["Buffs"] = {
                    order = 2,
                    groupType = "cdm", -- [DYNAMIC] "cdm" | "dynamic"
                    groupCategory = "buff", -- [CATEGORY] "skill" | "buff"
                    autoFilter = "HELPFUL", -- BuffIconCooldownViewer 소속
                    enabled = true,
                    iconSize = 36,
                    aspectRatioCrop = 1.0,
                    spacing = 2,
                ...
                ["Utility"] = {
                    ...
                    groupType = "cdm", -- [DYNAMIC] "cdm" | "dynamic"
                    groupCategory = "skill", -- [CATEGORY] "skill" | "buff"
                    autoFilter = "UTILITY", -- UtilityCooldownViewer 소속
                    enabled = true,
                    iconSize = 36,
                    aspectRatioCrop = 1.0,
                    spacing = 2,
                ...
                -- [DYNAMIC] 동적 아이콘 그룹 — CustomIcons 그룹에서 런타임 마이그레이션
