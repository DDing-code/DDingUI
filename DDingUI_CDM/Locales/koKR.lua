...
L["Active Effect Display"] = "활성효과 표시"
L["Active Swipe"] = "활성 스와이프"
L["Swipe and Glow"] = "스와이프 + 글로우"
L["Swipe Only"] = "스와이프만"
L["Glow Only"] = "글로우만"
L["Glow and Duration"] = "글로우 + 지속시간"
L["Hide Active Effect"] = "활성효과 숨기기"
...
L["Ready Glow Only in Combat"] = "사용 가능 글로우: 전투 중에만"
L["Glow Color Mode"] = "글로우 색상 방식"
L["Blizzard Glow"] = "블리자드 기본 글로우"
L["Keep Blizzard Default Glow Color"] = "블리자드 기본 색상"
...
L["Totem Slot"] = "토템 슬롯"
L["Unsupported in 12.1"] = "12.1 미지원"
L["Deleted Alert Condition"] = "삭제된 조건 - 다시 선택하세요"
L["Aura Applications Increased"] = "오라 중첩 증가 (소리)"
L["Aura Alert Support"] = "12.1 자동 오라: 생성·제거·중첩 증가 시 소리와 활성 중 시각 효과를 지원합니다. 전투 조건은 소리를 지원합니다. 남은 시간·중첩 수치 비교, 지연·반복 오라 소리, 오라와 전투 조건의 결합은 지원하지 않습니다. 기존 미지원 설정은 보존되지만 실행되지 않습니다."
L["Aura Alert Unsupported Condition"] = "지원되는 조건을 선택하세요. 전체 조건을 사용할 때는 같은 오라 상태·이벤트끼리 또는 전투 조건끼리만 결합할 수 있습니다."
L["Aura Alert Event Sound Only"] = "오라 소리는 생성·제거·중첩 증가 이벤트마다 한 번 재생합니다."
L["Aura Alert Present Visual Only"] = "시각 효과는 오라 활성 조건에서 지원합니다. 제거·중첩 증가·전투 조건에는 소리를 사용하세요."
L["Aura Alert External Glow Only"] = "동작 전용 오라는 선택한 CDM·커스텀 아이콘의 반짝임을 지원합니다. 대상 아이콘을 선택하세요."
L["Aura Alert Single Glow Target"] = "이 오라의 반짝임 동작은 모두 같은 대상 아이콘을 사용해야 합니다."
L["Aura Alert Self Visual Only"] = "해당 오라의 바·원형·아이콘·텍스트에 색상·반짝임·흑백을 적용할 수 있습니다. 그룹·자원바 대상은 지원하지 않습니다."
L["Aura Group Alert Support"] = "12.1 그룹 조건은 수동·주문 트래커만 지원합니다. 자동 오라 소리·시각 효과는 각 자식 오라에서 설정하세요. 기존 자동 오라 그룹 조건은 실행되지 않습니다."
