...
L["Ready Glow Only in Combat"] = "Ready Glow Only in Combat"
...
L["Unsupported in 12.1"] = "Unsupported in 12.1"
L["Deleted Alert Condition"] = "Deleted condition - select another"
L["Aura Applications Increased"] = "Aura stacks increased (sound)"
L["Aura Alert Support"] = "12.1 automatic auras: sounds on application, removal, or stack increase; visuals while the aura is present. Combat conditions support sounds. Remaining time, stack thresholds, delayed/repeating aura sounds, and mixed aura/combat conditions are unsupported. Saved unsupported settings are kept but do not run."
L["Aura Alert Unsupported Condition"] = "Choose a supported condition. Combined conditions must describe the same aura event, or contain only combat conditions."
L["Aura Alert Event Sound Only"] = "Aura sounds play once per application, removal, or stack increase."
L["Aura Alert Present Visual Only"] = "Aura visual actions require an active aura condition. Use a sound for removal, stack increase, or combat."
L["Aura Alert External Glow Only"] = "An action-only aura supports glow on a selected CDM or custom icon. Select a target icon."
L["Aura Alert Single Glow Target"] = "All glow actions on this aura must use the same target icon."
L["Aura Alert Self Visual Only"] = "Use this aura's own bar, ring, icon, or text for color, glow, and desaturation. Group and resource bar targets are unsupported."
L["Aura Group Alert Support"] = "12.1 group conditions support manual/spell trackers only. Configure automatic aura sounds and visuals on each child aura. Existing automatic aura conditions do not run."
