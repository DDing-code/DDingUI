...
local function CreateDivider(parent, y)
    ...
    line:SetHeight(1)
    line:SetColorTexture(0.22, 0.23, 0.27, 0.72)
    return line
end
...
local function CreateButton(parent, label, accent)
    ...
    button:SetHeight(26)
    local border = accent and { 1, 0.36, 0.06, 0.9 } or { 0.18, 0.48, 0.6, 0.9 }
    SetSurface(button, { 0.035, 0.04, 0.048, 1 }, border)
    ...
    button:SetScript("OnLeave", function(self)
        self:SetBackdropColor(0.035, 0.04, 0.048, 1)
...
local function CreateModeButton(parent, label)
    ...
    button.underline:SetColorTexture(1, 0.36, 0.06, 1)
...
function GUI.CreateGroupSystemWorkspace(contentFrame, parentFrame)
    ...
    SetSurface(inspector, { 0.04, 0.042, 0.05, 1 }, { 0.16, 0.17, 0.2, 1 })
    ...
    SetSurface(inspectorHeader.iconFrame, { 0.02, 0.022, 0.026, 1 }, { 0.28, 0.3, 0.34, 1 })
    ...
    SetSurface(modeBar, { 0.055, 0.058, 0.068, 1 }, { 0.13, 0.14, 0.17, 1 })
    ...
    SetSurface(centerHeader, { 0.045, 0.048, 0.056, 1 }, { 0.17, 0.18, 0.22, 1 })
    ...
    SetSurface(canvas, { 0.018, 0.02, 0.024, 1 }, { 0.15, 0.16, 0.19, 1 })
    ...
    SetSurface(selectionStrip, { 0.06, 0.065, 0.075, 0.96 }, { 0.14, 0.61, 0.72, 0.75 })
